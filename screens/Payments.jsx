    ...
    <>
      ...
      <View className="flex-1 bg-gray-50">
        <ScrollView className="flex-1 px-4 pt-2" contentContainerStyle={{ paddingBottom: 20 }}>
          ...
          <View className="flex-row justify-between mb-6 bg-white rounded-xl p-1 shadow-sm border border-gray-100">
            {paymentMethods.map((method) => {
              ...
              return (
                <TouchableOpacity
                  ...
                  className={`flex-1 items-center py-3 rounded-lg ${isSelected ? 'bg-green-50' : ''}`}
                >
            ...
            {selectedMethod === 'card' && (
              <View className="space-y-3">
                ...
                {cards.map((card) => (
                  <TouchableOpacity
                    key={card.id}
                    className="bg-white p-4 rounded-xl border border-gray-200 flex-row items-center shadow-xs"
