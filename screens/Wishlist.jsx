        ...
        <ScrollView className="flex-1 pb-20">
          <View className="p-4">
            ...
            {(!loading && wishlist.length === 0) ? (
              <View className="bg-white p-5 rounded-2xl border-gray-200 mb-4 flex items-center justify-center h-48">
              ...
              wishlist.map((item) => (
                <View key={item._id} className="flex-row bg-white p-4 rounded-xl border border-gray-200 mb-3">
                  <TouchableOpacity
                    activeOpacity={0.75}
